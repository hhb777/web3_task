...
describe("Test MetaNodeStake", async function() {
    ...
    it("deploy MetaNodeStake contract", async function() {
        // await deployments.fixture(["deployMetaNode"]);
        [siger] = await ethers.getSigners()
        //先部署token合约
        const MetaNodeTokenContract = await ethers.getContractFactory("MetaNodeToken");
        MetaNodeToken = await MetaNodeTokenContract.deploy();
        ...
        await tx.wait()
        lastblocknum = await ethers.provider.getBlockNumber();
    });


    it("add ETH to pool test", async function() {
        /**
         * 添加池测试
         * 参数一、token合约地址
         * 参数二、池权重
    ...
    it("add metatoken to pool test", async function() {
        // MetaNode代币加入池
    ...
    it("update pool test", async function() {
        /**
         * 更新池测试
         */
    ...
    it("config pool weight test", async function() {
        /**
         * 设置池权重
        */
    ...
    it("stake native currency test", async function() {
        /**
         * 质押native currency
         */
